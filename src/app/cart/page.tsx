...
export default async function cart() {
  return (
    <>
      <Navbar />
      <main className=" relative z-10 after:contents-[''] after:absolute after:z-0 after:h-full xl:after:w-1/3 after:top-0 after:right-0 after:bg-gray-50">
          ...
          <div className="grid grid-cols-12">
            <div className="col-span-12 xl:col-span-8 lg:pr-8 pt-14 pb-8 lg:py-24 w-full max-xl:max-w-3xl max-xl:mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 w-full">
                  <div className="md:col-span-2">
                    <div className="flex flex-col max-[500px]:items-center gap-3">
                      ...
                      <h6 className="font-medium text-base leading-7 text-gray-600 transition-all duration-300 group-hover:text-orange-500">
                        $120.00
                      </h6>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center max-[500px]:justify-center md:justify-end max-md:mt-3 h-full">
                    <p className="font-bold text-lg leading-8 text-gray-600 text-center transition-all duration-300 group-hover:text-orange-500">
                      $120.00
                    </p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-end mt-8">
                <button className="flex items-center px-5 py-3 rounded-full gap-2 border-none outline-0 group font-semibold text-lg leading-8 text-orange-500 shadow-sm shadow-transparent transition-all duration-500">
                  Add Coupon Code
                </button>
              </div>
            </div>
              ...
              <div className="mt-8">
                ...
                <form>
                  ...
                  <div className="flex items-center justify-between py-8">
                    ...
                    <p className="font-semibold text-xl leading-8 text-orange-500">
                      $485.00
                    </p>
                  </div>
                  <button className="w-full text-center bg-orange-500 rounded-xl py-3 px-6 font-semibold text-lg text-white transition-all duration-500">
                    Checkout
                  </button>
                </form>
              </div>
